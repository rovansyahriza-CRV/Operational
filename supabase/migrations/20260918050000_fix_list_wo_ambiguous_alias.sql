BEGIN;
-- list_wo pakai alias tabel "w" yang tabrakan sama variabel PL/pgSQL "w operational.work_orders"
-- yang dideklarasikan di awal op_api(). Postgres gak bisa nentuin w.contract_id itu kolom tabel
-- atau field variabel -> error 42702 "column reference is ambiguous" di SETIAP panggilan list_wo,
-- termasuk permintaan "Muat daftar WO" yang gak pernah berhasil dari awal fitur ini dibuat.
